...
def _load_class_count_from_meta(dataset_root, default_count=19):
    import json
    import os
...
num_classes = _load_class_count_from_meta(data_root, default_count=19)
if num_classes == len(whu_stree_benchmark_names_19):
    class_names = whu_stree_benchmark_names_19
else:
